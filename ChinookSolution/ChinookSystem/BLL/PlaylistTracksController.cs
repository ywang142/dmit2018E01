...
namespace ChinookSystem.BLL
{
    public class PlaylistTracksController
    {
        ...
        public void Add_TrackToPLaylist(string playlistname, string username, int trackid)
        {
            using (var context = new ChinookContext())
            {
                // use the BusinessRuleException to throw error to the web page
                ...
                // toENSURE these results the query will be wrap in a .FirstOrDefault()
                ...
                else
                {
                    ...
                    //      to be properly created on  PlayList AND placed
                    //      correctely in the "child" record of PlaylistTracks
