...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <h1>Filter Search</h1>
    ...
    <div class="col-md-offset-1">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldReleaseYear" runat="server" ErrorMessage="ReleaseYear field is required" Display="None"
            ForeColor="Firebrick" SetFocusOnError="true" ControlToValidate="EditReleaseYear"></asp:RequiredFieldValidator>
        <asp:RangeValidator ID="RangeEditReleaseYear" runat="server" ErrorMessage="Year needs to be between to 1950 and today" Display="None"
       ...
       <asp:DropDownList ID="EditAlbumArtistList" runat="server" DataSourceID="EditArtistListODS" DataTextField="Name" DataValueField="ArtistID" ></asp:DropDownList>
        ...
        <asp:LinkButton ID="Remove" runat="server" CausesValidation="false" OnClick="Remove_Click" OnClientClick="return confirm('Are you sure you wish to remove this album from the collection.')">Remove</asp:LinkButton>
    </div>
    <asp:ObjectDataSource ID="AlbumListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Album_FindByArtist" TypeName="ChinookSystem.BLL.AlbumController" OnSelected ="CheckForException">
        <SelectParameters>
